...
export default async function AdminStudentDetailPage({ params }: AdminStudentDetailPageProps) {
    ...
    const studentData = await getStudentProfileDetails(studentId);
        ...
        return (
            <div className="flex justify-center items-center h-full p-4">
                <Alert variant="destructive" className="w-full max-w-md">
                    ...
                    <AlertDescription>
                        A student profile with the ID <span className="font-mono bg-destructive/20 px-1 py-0.5 rounded">{studentId}</span> could not be found.
